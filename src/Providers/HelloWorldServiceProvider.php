...
class HelloWorldServiceProvider extends ServiceProvider
{
    ...
    protected function bootForConsole(): void
    {
        ...
        /*$this->publishes([
            __DIR__.'/../resources/views' => base_path('resources/views/vendor/pacturan'),
        ], 'hello-world.views');*/

        // Publishing assets.
        /*$this->publishes([
            __DIR__.'/../resources/assets' => public_path('vendor/pacturan'),
        ], 'hello-world.views');*/

        // Publishing the translation files.
        /*$this->publishes([
            __DIR__.'/../resources/lang' => resource_path('lang/vendor/pacturan'),
        ], 'hello-world.views');*/
